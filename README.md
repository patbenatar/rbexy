...
Love JSX and component-based frontends, but sick of paying the costs of SPA development? Rbexy brings the elegance of JSX -- operating on HTML elements
and custom components with an interchangeable syntax -- to the world of Rails server-rendered apps.
